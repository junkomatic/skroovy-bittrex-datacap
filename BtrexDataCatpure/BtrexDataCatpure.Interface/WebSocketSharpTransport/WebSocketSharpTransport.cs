...
using BtrexDataCapture.Interface.WebSocketSharpTransport.Extensions;
using BtrexDataCapture.Interface.WebSocketSharpTransport.Helpers;
using System;
...
namespace BtrexDataCapture.Interface.WebSocketSharpTransport
{
